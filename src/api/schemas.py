...
EducationType   = Literal["SSC", "12TH", "UNDER GRADUATE", "GRADUATE",
...
class PredictionRequest(BaseModel):
    ...
    NETMONTHLYINCOME:  float = Field(..., ge=0, le=10_000_000, description="Net monthly income in INR")
    Time_With_Curr_Empr: int = Field(..., ge=0, le=600,        description="Months with current employer")
    ...
    # Product enquiries
    last_prod_enq2:  ProductType = Field(..., description="Most recent product enquiry type")
    first_prod_enq2: ProductType = Field(..., description="First ever product enquiry type")
